...
useful if you want to run it on your own systems.
...
|MN_ADDR_BOOK| This variable has to contain a base64 encoded JSON string which contains all the recipients known to the backend. The format of the JSON data is specified below (see Address Book)| Yes |
...
export MN_ADDR_BOOK=
./notifier
``` 
